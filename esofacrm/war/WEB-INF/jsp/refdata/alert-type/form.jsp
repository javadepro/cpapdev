...
<div id="formwrapper">
<form:form id="alert-form" commandName="alertType"
	action="/refdata/alert-type/formsubmit" method="POST" >
<div id="title">
...
<form:hidden path="id" />
	...
	<h2>Basic Details</h2>
	<ul>
		<li><label>Alert Type:</label> <form:input path="type" size="40"
				cssErrorClass="form-error-field" /> <form:errors cssClass="error"
				path="type" /></li>
		<li><label>Alert Category:</label> <form:input path="alertCategory" size="40"
						cssErrorClass="form-error-field" /> <form:errors cssClass="error"
						path="type" /></li>				
	</ul>
	...
	<br />
	<a id="add-type" href="/refdata/alert-type/subtype-form?parentId=<c:out value="${alertType.id}" />" class="bluebtn open-on-tab">Add a Subtype</a> 
	</c:if>
	<br /><br />
	
	<script>
		setupAjaxFormReplace("alert-form","formwrapper");
