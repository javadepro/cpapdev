...
<p>Reference data : Sleep Clinic, the entity that reference the Sleep Doctor</p>

<form:form id="sleep-clinic-form" commandName="sleepClinic"
	action="/refdata/sleep-clinic/formsubmit" method="POST">
	<form:hidden path="id" /> 
	...
	<script>
	setupAjaxFormReplace("sleep-clinic-form","formwrapper");
	</script>
</form:form>
</div>