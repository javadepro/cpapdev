...
<form:form id="family-doctor-form" commandName="familyDoctor"
	action="/refdata/family-doctor/formsubmit" method="POST">
	<form:hidden path="id" />
	...
	<c:if test="${message!=null}">
		...
		<li><label>Billing Number:</label> <form:input
				path="physicianBillingNumber" size="40"
				cssErrorClass="form-error-field" />
			</li>
		</ul>
...
setupAjaxFormReplace("family-doctor-form","formwrapper");
</script>
</form:form>
</div>
