...
<form:form commandName="manufacturer" action="/refdata/manufacturer/formsubmit"
	method="POST" id="manufacturer-form">
	<form:hidden path="id" />
	...
	<ul>
		<li><label>Name:</label> <form:input path="name" size="40"
				...
				<form:errors cssClass="error" path="name" /></li>
		<li><input type="submit" value="Save" class="bluebtn"/></li>
	</ul>
	<script>
	setupAjaxFormReplace("manufacturer-form","formwrapper");
	</script>
</form:form>
</div>
