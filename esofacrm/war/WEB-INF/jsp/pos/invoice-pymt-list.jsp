...
<div id="invoiceTitle">
<h1><div id="icon-tools" class="icon32"></div><span style="float:left; margin-left: 5px; margin-top: 6px;">Invoice Payment History</span></h1>
</div>
<div style="clear:both; width: 100%;" />

			<form:form id="invoicePymtForm" commandName="invoicePymtForm"
				action="/pos/invoice-pymt-formsubmit-p" method="POST">
			...
			<table style="width: 100%;">
				...
				<tr>
						...
						<td style="padding: 5px;">
 						...
 						<td class="invoice-item-numeric">
 							<c:out value="${invoice.clientPortion}"/>
 						</td>
 						<td></td>
 					</tr>				
...
<div class="invoice-buttons">
	...
	<a href="/pos/invoice-pymt?invoiceNumber=<c:out value="${invoice.invoiceNumber}" />" style="color:#FFF;" class="bluebtn" id="refreshBtn">Refresh</a>&nbsp;&nbsp;	
