...
public class CredentialMediator {
  ...
  public CredentialMediator(HttpServletRequest request,
    ...
    try {
      ...
      secrets = GoogleClientSecrets.load(
          JSON_FACTORY, new InputStreamReader(clientSecretsStream));
   ...
   *                                 address was null.
   */
  private Userinfoplus getUserInfoplus(Credential credential)
    ...
    try {
      ...
      if ((credential == null || credential.getRefreshToken() == null)
        ...
        if (credential != null) {
          ...
          userId = userInfoplus.getId();
          request.getSession().setAttribute(USER_ID_KEY, userId);
          request.getSession().setAttribute(EMAIL_KEY, userInfoplus.getEmail());
